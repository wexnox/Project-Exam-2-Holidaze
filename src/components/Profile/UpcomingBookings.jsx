// Shows the authenticated customer's upcoming bookings
...
// TODO: Add JSDoc. Broken / not implemented fully

function UpcomingBookings() {
  const { data, isLoading, isError, fetchData } = useContext(SettingsContext); // <- TODO: duplicate fix later
  const [isDoneFetching, setIsDoneFetching] = useState(false);
  const { name, accessToken } = getLocalStorage('user');
  const upComingBookings = data.bookings // <- TODO: Unresolved variable
    ? data.bookings
        .filter(
